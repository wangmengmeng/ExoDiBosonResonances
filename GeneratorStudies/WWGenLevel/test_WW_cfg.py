...
process.jet = cms.EDFilter("LargestPtCandViewSelector",
                           src = cms.InputTag("ak7GenJets"),
                           maxNumber = cms.uint32(1)
                           )

process.analysis = cms.EDFilter("LeptonicWMaker",
                                lepton = cms.untracked.InputTag("lepton"),
                                neutrino = cms.untracked.InputTag("neutrino"),
                                jet = cms.untracked.InputTag("jet"),
                                MET = cms.untracked.InputTag("genMetTrue")
                                )
#process.p = cms.Path(process.printTree)
process.p = cms.Path(process.lepton + process.neutrino + process.jet + process.analysis)
