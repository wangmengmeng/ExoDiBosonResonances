...
real(8), public, parameter :: M_Reso  = MASSRESONANCEd0     *GeV      ! X resonance mass (spin 0, spin 1, spin 2)
real(8), public, parameter :: Ga_Reso = WIDTHRESONANCEd0     *GeV      ! X resonance width
...
!-- see mod_Graviton
  ...
  complex(8), public, parameter :: b1 = (0.033d0,0d0)    !  all b' below are g's in the draft
  ...
  complex(8), public, parameter  :: c1 = (0.0d0,0d0)
