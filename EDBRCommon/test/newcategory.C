...
int newcategory()
{
	...
	int treetype=0; //1 for fullrange, 0 for ttbarcontrol
	...
	for(unsigned int fi=0; fi <filelist.size(); fi++)
	{
		...
		double nsubjetbtagLAna[99];
		double subjetPurityAna[99];
		...
		tAnaSig->Branch("nsubjetbtagL",    &nsubjetbtagLAna, "nsubjetbtagL[nCands]/D");
                tAnaSig->Branch("subjetPurity"          ,&subjetPurityAna        ,"subjetPurity[nCands]/D");
		...
		double nsubjetbtagLAnaPlain;
		double subjetPurityAnaPlain;
		int nXjetsAnaPlain;
		...
		tAnaSigPlain->Branch("vTagPurity"          ,&vTagPurityAnaPlain        ,"vTagPurity/D");
                tAnaSigPlain->Branch("subjetPurity"          ,&subjetPurityAnaPlain        ,"subjetPurity/D");
		tAnaSigPlain->Branch("nsubjetbtagL",       &nsubjetbtagLAnaPlain,    "nsubjetbtagL/D");
...
//				else continue;
				...
				if(nsubjetbtagL[ivec]==0) subjetPurityAna[ivec]=0;
				else if(nsubjetbtagL[ivec]>=2)subjetPurityAna[ivec]=1;
				else subjetPurityAna[ivec]=-1;
				...
				nsubjetbtagLAna[ivec]=nsubjetbtagL[ivec];
				mJJNoKinFitAnaSig[ivec]=mJJNoKinFit[ivec];
				MCmatchAna[ivec]=MCmatch[ivec];

				//define 8 categories: 
				if(lepAna[ivec]==0&&subjetPurityAna[ivec]==0&&nXjetsAna[ivec]==1&&region[ivec]==1)categories[ivec]=0;//0 ele SR 1J L0
				else if(lepAna[ivec]==0&&subjetPurityAna[ivec]==1&&nXjetsAna[ivec]==1&&region[ivec]==1)categories[ivec]=1;//1 ele SR 1J L2
                                else if(lepAna[ivec]==0&&subjetPurityAna[ivec]==0&&nXjetsAna[ivec]==1&&region[ivec]==0)categories[ivec]=2;//1 ele SB 1J L0
                                else if(lepAna[ivec]==0&&subjetPurityAna[ivec]==1&&nXjetsAna[ivec]==1&&region[ivec]==0)categories[ivec]=3;//1 ele SB 1J L2
                                else if(lepAna[ivec]==1&&subjetPurityAna[ivec]==0&&nXjetsAna[ivec]==1&&region[ivec]==1)categories[ivec]=4;//0 mu SR 1J L0
                                else if(lepAna[ivec]==1&&subjetPurityAna[ivec]==1&&nXjetsAna[ivec]==1&&region[ivec]==1)categories[ivec]=5;//1 mu SR 1J L2
                                else if(lepAna[ivec]==1&&subjetPurityAna[ivec]==0&&nXjetsAna[ivec]==1&&region[ivec]==0)categories[ivec]=6;//1 mu SB 1J L0
                                else if(lepAna[ivec]==1&&subjetPurityAna[ivec]==1&&nXjetsAna[ivec]==1&&region[ivec]==0)categories[ivec]=7;//1 mu SB 1J L2
