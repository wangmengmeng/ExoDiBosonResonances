...
elebins_pt  = [20,40,60,90,120,150,200,250,300,400,500,600,700,800,900,1000]
elebins_eta = [0.,0.3,0.9,1.2,1.4442,1.566,1.9,2.2,2.5]

jetbins_pt =  [30,50,80,120,150,200,250,300,400,500,600,700,800,900,1000]
jetbins_eta=  [0.,0.3,0.9,1.2,1.5,1.8,2.1,2.4]

mubins_pt  =  elebins_pt
mubins_eta =  jetbins_eta

histo_ele_gen     = root.TH2F("ele_gen","ele_gen",15,array('d',elebins_pt),8,array('d',elebins_eta))    
...
histo_mu_gen     = root.TH2F("mu_gen","mu_gen",15,array('d',mubins_pt),7,array('d',mubins_eta))    
...
histo_jet_gen      = root.TH2F("jet_gen","jet_gen",14,array('d',jetbins_pt),7,array('d',jetbins_eta)) # gen quantities of all resonances in accptance   
...
def makePlots():
    ...
    #eff
    output = root.TFile.Open("efficiency.root","UPDATE")
