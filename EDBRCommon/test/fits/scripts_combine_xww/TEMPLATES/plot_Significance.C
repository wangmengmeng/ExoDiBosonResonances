...
void plot_Significance(bool unblind=true);
...
void plot_Significance(bool unblind){
 ...
 iMH=0;
  ...
  double fr_left=990, fr_down=1e-06,fr_right=2500.0,fr_up=0.6;
  ...
  l1->DrawLine(1000.0,quant1sigma,2500.0,quant1sigma);
  TLine *l2=new TLine();
  l2->SetLineStyle(2);
  l2->SetLineWidth(3.0);
  l2->SetLineColor(kRed);
  l2->DrawLine(1000.0,quant2sigma,2500.0,quant2sigma);
  TLine *l3=new TLine();
  l3->SetLineStyle(2);
  l3->SetLineWidth(3.0);
  l3->SetLineColor(kRed);
  l3->DrawLine(1000.0,quant3sigma,2500.0,quant3sigma);
  TLine *l4=new TLine();
  l4->SetLineStyle(2);
  l4->SetLineWidth(3.0);
  l4->SetLineColor(kRed);
  l4->DrawLine(1000.0,quant4sigma,2500.0,quant4sigma);
